// SMSC.KZ API (smsc.kz) версия 2.9 (05.03.2015)
using System;
using System.Net;
using System.IO;
...
namespace ESA.Common
{
    public class SMSC
    {
        ...
        const string SMSC_LOGIN = "Webkassa";          // логин клиента
        const string SMSC_PASSWORD = "pE$9A6Ce";    // пароль или MD5-хеш пароля в нижнем регистре
        ...
        const string SMTP_FROM = "saparovsk@yahoo.com";     // e-mail адрес отправителя
        const string SMTP_SERVER = "send.smsc.kz";  // адрес smtp сервера
        const string SMTP_LOGIN = "87025360737";               // логин для smtp сервера
        const string SMTP_PASSWORD = "ASD123qwe";            // пароль для smtp сервера
        ...
        private string[] _smsc_send_cmd(string cmd, string arg, string[] files = null)
        {
            ...
            string url = (SMSC_HTTPS ? "https" : "http") + "://smsc.kz/sys/" + cmd + ".php" + (SMSC_POST ? "" : "?" + arg);
            ...
            do
            {
                ...
                if (i == 2)
                    url = url.Replace("://smsc.kz/", "://www2.smsc.kz/");
        ...
        private string _urlencode(string str)
        {
            ...
            return str;/*HttpUtility.UrlEncode(str);*/
        }
    ...
    // string[] r = smsc.send_sms("79999999999", "http://smsc.kz\nSMSC.KZ", 0, "", 0, 0, "", "maxsms=3");
